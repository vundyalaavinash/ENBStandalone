   ...
   Calendar currentDate = Calendar.getInstance();
    ...
    public SelectView() {
        ...
        try {
           ...
           // 
            if("".equals(proj[0])){ JOptionPane.showMessageDialog(null,"NO ENB's exist. Create ENB by clicking ok");
            this.dispose();
    ...
    private void jComboBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox2ActionPerformed
        try {
            this.dispose();
                  new ViewENB(username, (String) jComboBox2.getSelectedItem()).setVisible(true);
        } catch (Exception ex) {
            Logger.getLogger(SelectView.class.getName()).log(Level.SEVERE, null, ex);
        }
